...
This Android app creates an AI coach (Ralsei from Deltarune) that observes user activity through automated screenshots and provides contextual dialogue responses.
